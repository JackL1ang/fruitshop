...
<header>
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        ...
        <div class="container-fluid">
            <a class="navbar-brand" href="${pageContext.request.contextPath}/index.jsp"><img class="logo-header" src="picture/logo.png"></a>
...
<%--                    if(username==null){ %>--%>
                    <c:if test="${empty user}">
                        <div id="button-all">
                            <label  type="button" class="btn btn-outline-light me-2 show-login"  >
                                登 录
                            </label>

                            <button  id="btn-register" type="button" class="btn btn-warning" data-toggle="modal" data-target="#myModal_reg">注 册</button>
                        </div>
                    </c:if>
<%--                    <%}else { %>--%>
                        <c:if test="${!empty user}">
                            <div class="header-widget-group right">
                                <div class="dropdown dropdown-menu-end">
                                        <a class="btn btn-dark dropdown-toggle header-widget" data-bs-toggle="dropdown" title="我的账户">
                                            <img src="${pageContext.request.contextPath}/picture/favicon.png"><span>欢迎：${user.username}</span>
                                        </a>
...
<%--                    <% } %>--%>
                    <div class="login-box">
                        ...
                        <div id="error_box" class="error_msg msg_color">

                        </div>
                        <form action="/fruitshop/loginServlet" method="post">
