...
@WebServlet(name = "AdminModifyGoodServlet", value = "/AdminModifyGoodServlet")
public class AdminModifyGoodServlet extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String i = String.valueOf(goodService.modifyGood(params));
